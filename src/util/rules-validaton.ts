...
const passwordConfirmation = (password: string, passwordConfirmation: string) => {
...
export { required, isEmail, validateValue, passwordConfirmation, isValidCPFCNPJ, validate_cep };
